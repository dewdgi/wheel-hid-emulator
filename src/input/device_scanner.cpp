...
void DeviceScanner::RefreshDevicesLocked(bool force) {
...
void DeviceScanner::EnsureManualDeviceLocked(const std::string& path, bool want_keyboard, bool want_mouse) {
    if (path.empty()) {
        return;
    }
